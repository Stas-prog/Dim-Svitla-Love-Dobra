...
const rooms = [
  { id: "platforms", title: "Зала платформ", desc: "Усі офіційні канали Дому Світла 🌐" },
  { id: "happiness", title: "Генератор Щастя", desc: "Дарує тобі промінь радості 💛" },
  { id: "throughEarth", title: "Кімната через Землю", desc: "Відкрий портал до протилежної частини світу 🌍" },
